#!/usr/bin/env python3
"""
Costmap Publisher executable wrapper
"""
import sys
import os
...
try:
    from vineyard_mower_navigation.costmap_generator import main
    ...
    module_path = os.path.join(os.path.dirname(__file__), '..', 'vineyard_mower_navigation', 'costmap_generator.py')
